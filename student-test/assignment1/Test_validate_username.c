...
void test_validate_my_username()
{
     ...
     */
    const char *username_1;
    username_1 = my_username();
    
    const char *username_2;
    username_2 = malloc_username_from_conf_file();

    TEST_ASSERT_TRUE_MESSAGE(username_1, username_2);
